    ...
    <div className="rounded-2xl overflow-hidden transition-shadow hover:shadow-md"
      ...
      <div className="flex items-center justify-between px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-semibold" style={{ color: P.dark }}>{resident.ownerName}</p>
            <div className="flex items-center gap-3 mt-0.5">
              <span className="flex items-center gap-1 text-xs" style={{ color: P.muted }}>
          ...
          {resident.familyMembers.map((fm, i) => (
            <div key={fm.id ?? i}
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <p className="text-xs font-medium" style={{ color: P.dark }}>{fm.name}</p>
                  {fm.relationship && (
              ...
              <div className="text-right">
                {fm.phone && (
                  <p className="text-xs flex items-center gap-1" style={{ color: P.muted }}>
